        ...
        ALC.map((item) => (
          <div key={item.id} className="sm:mx-auto">
            <div className="lg:flex lg:justify-around justify-center">
              <img
                src={item.logo}
                className="rounded-full w-80 h-80 sm:mx-auto"
                alt="Logo"
              />
              ...
              <div className="lg:flex sm:block lg:mt-5">
                <div className="lg:w-[23rem] text-justify">
                  <p className="mb-3 text-gray-500 dark:text-gray-400 shadow p-3">
                    ...
                    iure quasi dignissimos dolorum nesciunt, totam rerum dolor,
                    molestiae, obcaecati aut sequi quia doloremque.
                  </p>
                  <p className="text-gray-500 dark:text-gray-400 sm:my-5 mt-3 shadow p-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                ...
                <ul className="space-y-1  list-inside text-gray-500 lg:ml-10 shadow p-3 h-max leading-loose">
                  {item.courses.map((course, idx) => (
                    <li
                      key={idx}
                      className="flex items-center text-lg hover:text-blue-700 cursor-pointer selection:text-white selection:bg-red-500"
                    >
                      <svg
