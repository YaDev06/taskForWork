...
export default function Mentors() {
  ...
  return (
    <div className="lg:w-8/12 md:w-3/6 sm:5/6 m-auto">
      ...
      <div className="flex flex-wrap text-center lg:min-h-[70vh] sm:min-h-[63vh]">
        {LCMentors ? (
            ...
            >
              <div className="relative overflow-hidden">
                <img
                  ...
                  alt=""
                />
                <div className="card absolute top-3 left-3 hidden group-hover:block z-30">
                  <a href={mentor.telegram} target="_blank">
                  ...
                  <a href={mentor.instagram} target="_blank">
                    <div className="rounded-lg border bg-white p-2 mt-3">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                        height="25"
                  ...
                  <a href={mentor.youtube} target="_blank">
                    <div className="rounded-lg border bg-white p-2 mt-3">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                        height="25"
                        fill="currentColor"
                        className="bi bi-youtube text-red-600"
                        viewBox="0 0 16 16"
                      >
              ...
              <div className="p-5">
                ...
                <p className="text-gray-800 italic">{mentor.expert} mentori</p>
                <p className="mb-3 font-normal text-gray-600 dark:text-gray-400 italic">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum
                  inventore necessitatibus suscipit ducimus asperiores
                  veritatis.
                </p>
              </div>
            </div>
